...
public class MyDefaultWebSessionManager extends DefaultSessionManager implements WebSessionManager{
    ...
    public String DEFAULT_SESSION_ID_NAME="shiroJID";
    ...
    private Serializable getReferencedSessionId(ServletRequest request, ServletResponse response) {
        ...
        if (id != null) {
            ...
            id = getUriPathSegmentParamValue(request, DEFAULT_SESSION_ID_NAME);
